...
if (isset($_SESSION['utilisateur']) && is_array($_SESSION['utilisateur'])) {
    ...
    echo "<p class='text-white fs-5'>Bienvenue <strong>" . htmlspecialchars($_SESSION['utilisateur']['prenom']) . " " . htmlspecialchars($_SESSION['utilisateur']['nom']) . " !</strong></p>";
    echo '<div class="d-flex gap-2">';
    // Bouton Dashboard
    echo '<a class="btn btn-primary btn-rounded text-white d-flex align-items-center gap-2" href="/backoffice/dashboard.php">
    ...
    // Bouton Déconnexion
    echo '<a class="btn btn-danger btn-rounded text-white d-flex align-items-center gap-2" href="/auth/logout.php">
            <span class="icon-wrapper">
